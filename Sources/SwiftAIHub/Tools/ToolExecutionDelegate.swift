...
///
/// - Note: This decision is specific to SwiftAIHub's tool-call loop.
...
///
/// - Note: This delegate is specific to SwiftAIHub's tool-call loop.
///   FoundationModels runs its own internal loop and cannot honor it.
...
extension ToolExecutionDelegate {
  ...
  public func didGenerateToolCalls(
    _ toolCalls: [Transcript.ToolCall], in session: LanguageModelSession
  ) async {}
